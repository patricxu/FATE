...
class dataset_ContextualSBM(FedGraphDataset):
    ...
    def __init__(self,
        ...
        self._theta = [theta] if not isinstance(theta, list) else theta
            ...
            if not osp.isfile(p2f):
                ...
                if isinstance(self._Lambda, list):
                    for i, (Lambda,
                        ...
                        tmp_data, _ = ContextualSBM(self._n, self._d, Lambda,
                                                    self._p, mu,
                                                    self._train_percent)
    ...
    def __repr__(self):
        return '{}'.format(self.fed_dataset)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--phi', type=float, required=False, nargs='+')
    ...
    print(args.phi)
    tmp = dataset_ContextualSBM(root=args.root,
                          name=args.name,
                          theta=args.phi,
